...
const ConfigEditor = ({onSave}) => {
    const {config, loading, localSetConfig, showCluster, showError, setShowCluster, setShowError} = useContext(AppContext);
        ...
        <Box sx={{flexGrow: 1}}>
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={3}>
                    ...
                    <Button type="bu" sx={{backgroundColor: '#1E3A8A', color: 'white'}} variant="contained"
